...
//                String visibilityMode = "shown";
//                if (!boolValue) {
//                    visibilityMode = "hide";
//                }
                Intent intent = new Intent(preference.getContext(), NotificationReceiver.class);
//                intent.putExtra(NotificationReceiver.VISIBILITY_MODE_EXTRA, visibilityMode);
